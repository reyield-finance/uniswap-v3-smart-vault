...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  await deploy("WithdrawNativeToken", {
    from: deployer,
    args: [],
    log: true,
    autoMine: true,
  ...
  console.log(":: Deployed WithdrawNativeToken: ", (await deployments.get("WithdrawNativeToken")).address);
};

export default func;
func.tags = ["SmartVault", "Action", "WithdrawNativeToken"];
